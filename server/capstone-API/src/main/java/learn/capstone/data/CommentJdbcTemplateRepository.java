...
public class CommentJdbcTemplateRepository implements CommentRepository {
    ...
    public Comment add(Comment comment) {
        ...
        final String sql = "insert into comment (userId, content, outfitId, dateTime, hidden)"
                + "values (?,?,?,?, ?);";
        ...
        int rowsAffected = jdbcTemplate.update(connection -> {
            ...
            ps.setBoolean(4, comment.getHidden());
            return ps;
        }, keyHolder);
...
//                + "dateTime = ?, "
        ...
        return jdbcTemplate.update(sql,
                ...
                comment.getContent(),
                comment.getOutfitId(),
//I don't think we want people to be able to update the time
